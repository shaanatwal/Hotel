...
const { getLocations, getHotelsByLocation, createCustomer,  checkCustomerUserCredentials, getHotelChainsByHotelId, getHotelIdByName,getHotelChainsByHotelName, 
  checkEmployeeUserCredentials, createEmployee, createHotel, getCapacities, getRoomViews, getAmenities, searchRooms, createBooking, removeRoom, removeCustomer, removeHotel, removeEmployee
 } = require("./functions");
